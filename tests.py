...
class TestCCValidator(unittest.TestCase):
    ...
    def test1(self):
        ...
        Picked just to test my gradescope, but will fail length, prefix, and
        checksum
        """
        card_num = "0123456789"
    ...
    def test24(self):
        ...
        card_num = "2938475928374589723495782983457892374589729384579238475" \
                   "9827349587293487592834759273458972439572938457982374598" \
                   "2734598273458972938457928347598237"
        self.assertFalse(credit_card_validator(card_num),
                         msg='credit_card_validator({})'.format(card_num),)
    ...
    def test46a(self):
        """Partition test of length and checksum error Correct length.

        correct checksum, incorrect prefix caused by leading 0
        """
